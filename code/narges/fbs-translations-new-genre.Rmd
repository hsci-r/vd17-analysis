...
my_data_frames_1 <- list(fbs_translation_cat1,genres_number_fbs_cat1,genres_members_fbs_cat1)
my_data_frames_2 <- list(fbs_translation_cat2,genres_number_fbs_cat2,genres_members_fbs_cat2)
my_data_frames_3 <- list(fbs_translation_cat3,genres_number_fbs_cat3,genres_members_fbs_cat3)
...
fbs_translations_society_unrelated<- gs4_create(
...
fbs_translations_society_unrelated
```
