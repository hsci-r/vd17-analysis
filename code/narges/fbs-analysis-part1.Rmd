...
members_fbs %>%
  write_xlsx(here("fbs_members(not contributors_dedicatees).xlsx"))
...
members_fbs_all %>%
  write_xlsx(here("fbs_members_all.xlsx"))
...
genres_fbs %>% write_xlsx(here("fbs_genres(not contributors_dedicatees).xlsx"))
...
genres_fbs_all %>% write_xlsx(here("fbs_genres_all.xlsx"))
...
ger_translation_fbs %>% write_xlsx(here("german_translation_fbs(not contributors_dedicatees).xlsx"))
```
...
ger_translation_fbs_all %>% write_xlsx(here("all_german_translation_fbs.xlsx"))
```
...
translators_translation_fbs_all <- ger_translation_fbs_all %>% 
  filter(field_code=="028C",role2 %in% c("ÜbersetzerIn","Übersetzer",NA))  

primary_authors_translation_fbs_all %>%
  write_xlsx(here("all_fbs_primary_authors_ger_translations.xlsx"))

translators_translation_fbs_all %>% write_xlsx(here("all_fbs_translators_ger_translations.xlsx"))
```
