...
vd17_identical_fingerprints <- vd17_fingerprints_c %>%
  inner_join(vd17_fingerprints_c, join_by(f1_1, f1_2, f2_1, f2_2, f3_1, f3_2, f4_1, f4_2, f34_source, year, record_number < record_number)) %>%
  select(record_number.x, record_number.y) %>%
  compute_a()

vd17_identical_fingerprints_and_pagecounts <- vd17_fingerprints_c %>%
...
list(
  ...
  fingerprints_and_pages = vd17_identical_fingerprints_and_pagecounts,
