...
fbs_records_a <- fbs_raw_records_a %>%
  ...
  group_by(across(-c(method, set))) %>%
  summarise(set = case_when(
    any(set == "Society-contributed and society-purpose related") ~ "Society-contributed and society-purpose related",
    any(set == "Society-contributed") ~ "Society-contributed",
    T ~ "Society-associated"
...
fbs_records_a <- fbs_records_a %>%
  union_all(fbs_records_a %>%
    ...
    mutate(set = "Society-contributed")) %>%
  union_all(fbs_records_a %>%
    filter(set != "Society-associated") %>%
    mutate(set = "Society-associated")) %>%
